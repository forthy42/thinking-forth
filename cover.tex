...
\centerline{\psframebox*[fillcolor=black,framesep=0.125in]{\noindent
\white
...
\rotateleft{\advance\pheight-0.25in\vbox to \spine{\vss\hbox to \pheight{
