...
%\begin{interview} % need 1 blank line before blackline, like tip
...
\begin{enumerate}	%ARN - should be no space between items
...
The first step is to determine what the application should
...
\begin{enumerate} %ARN - no lines between items
...
% bullet list 	%ARN - too much space between items
\begin{itemize}
\item ignored
...
\wepsfigb{fig2-3}{A data-flow diagram.}
...
During one of our interviews I asked Moore\index{M!Moore, Charles|(} if he used
...
interface.\index{I!Interface definition}
...
names are preferred in real code---see \Chap{5}.)
...
% bullet list %ARN - no lines between items
\begin{itemize}
...
%\begin{interview}
\bigskip\blackline{2ex}
\noindent Moore continues:\index{M!Moore, Charles|(}
\begin{tfquot}
...
%\begin{interview}
\bigskip\blackline{2ex}
\noindent Moore concludes:\index{M!Moore, Charles|(}
\begin{tfquot}
...
\begin{references}{9}
\bibitem{harris81} Kim Harris, ``The FORTH Philosophy,''
  \emph{Dr. Dobb's Journal,} Vol. 6, Iss. 9, No. 59 (Sept. 81),
  pp. 6-11.
\bibitem{weinberg80} Victor Weinberg, \emph{Structured Analysis,}
  Englewood Cliffs, N.J.: Prentice-Hall, Inc., 1980.
\bibitem{stuart80} LaFarr Stuart, ``LaFORTH'',
  \emph{1980 FORML Proceedings,} p. 78.
\bibitem{brooks75} Frederick P. Brooks, Jr., \emph{The Mythical
