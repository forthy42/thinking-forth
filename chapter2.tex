...
\end{tfquot}
\person{Harris} then applies the scientific method to the software development
...
\person{Dave Johnson}'s meticulous approach to planning. \person{Johnson} is supervisor at
...
\end{interview}%
\index{J!Johnson, Dave|)}
\person{Johnson} advises us to complete the design specification before starting
...
\begin{interview}
\noindent \person{John Teleska} has been an independent software consultant
...
of what technology is able to do.'' \person{Teleska} works in Rochester, New York:
...
\index{T!Teleska,John|(}
\begin{interview}
\noindent Despite \person{Teleska}'s preference for a well-planned project, he
...
\noindent As \person{Starling} observes, you don't know completely what you're
...
\index{K!Kogge, Peter|(}
\begin{interview}
\noindent \person{Peter Kogge} is Senior Technical Staff in the IBM Federal
...
\index{J!Johnson, Dave|(}
\begin{interview}
\person{Johnson} of Moore Products Co. has a few words on \Forth{} pseudocode:
...
\begin{tip}
To simplify, quantitize.\index{Q!Quantization}
\end{tip}
