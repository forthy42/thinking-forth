...
\item[Segment 2:] \forth{WILLY NILLY\ \ 8 *\ \ PUDDING' PIE AND}
\end{description}
...
\begin{description}
\item[Segment 1:] \forth{BLETCH-AB\ \ \textbf{BLETCH-C}\ \ BLETCH-DEF}
\item[Segment 2:] \forth{BLETCH-AB\ \ \textbf{PERVERSITY}\ \ BLETCH-DEF}
\end{description}
...
\end{Code}
The word \forth{CONDITIONALLY} may---depending on the condition0---alter
