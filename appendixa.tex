...
Another defining word is {\bf CODE},\index{C!CODE} which is used in place of colon to
...
Still another defining word is {\bf CONSTANT},\index{C!CONSTANT} which
is used like this:
\begin{verbatim}
...
The defining word VARIABLE\index{V!VARIABLE} creates a location
...
FORTH provides all the control structures\index{C!Control structures:!defined}
...
The word {\bf ELSE}\index{E!ELSE} allows an alternate phrase to be executed
