...
\othersidetrue\section{Sharing Components}
\othersidefalse
\begin{tip}
...
\wepsfigt{fig7-7}{DOER and MAKE.}
\wepsfigt{fig7-8}{Multiple MAKEs in parallel using ;AND.}
\wepsfigt{fig7-9}{Multiple MAKEs in series.}
