...
represents the contents of the \forthb{DO LOOP}. The stack depth upon exiting
...
\item If used inside a \forthb{DO LOOP}, return stack operators must by symmetrical
...
write a word that employs a \forthb{DO LOOP} starting at the current position
...
\forth{DUMP} and \forth{CDUMP}. (Recognize that ``\forthb{1 +LOOP}''
