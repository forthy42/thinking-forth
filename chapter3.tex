...
design/decomposition|see{Prelimiary design}}
...
The buffers are defined with \forthb{CREATE}, the count is an ordinary
\forthb{VARIABLE}, and the attribute patterns are defined as \forthb{CONSTANT}s,
such as:
\begin{Code}
...
routines. There are 16 of these routines. You load register \code{AH} with the
...
reason). The region of memory begins at \forth{HEX} address \code{C000}. We want to
...
at \forth{HEX} address \forth{EFFF}. In other words, we must start at the end,
