...
\strut~~~var~h:~boolean~(indicates~hurried) \\
\strut~~~\textit{test~for~hurried}~ \\
\strut~~~if~h~=~true~then \\
\strut~~~~~~\textbf{call~make-cereal}~ \\
\strut~~~else \\
\strut~~~~~~\textbf{call~make-eggs} \\
\strut~~~end \\
\strut~~~\textbf{call~cleanup} \\
end}
