...
\wepsfigt{fig1-1}{Unstructured code, using jumps or {}``GOTOs.''}
...
%
\wepsfigt{fig1-3}{Structured programming with a non-structured language}
...
\wepsfigb{fig1-4}{Using a structured language.}
...
\othersidetrue\subsection{Designing from the Top}
\othersidefalse
