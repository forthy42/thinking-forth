\chapter*{Preface}\addcontentsline{toc}{section}{Preface}\markboth{Preface}{Preface}
...
FORTH. Otherwise, \Chap{A} of this book introduces FORTH fundamentals.
...
FORTH, \person{Charles Moore}. In addition to spending several days interviewing
