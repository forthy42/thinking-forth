...
Definitions for $\backslash${} and $\backslash${}S can be found in \App{C}.
...
If your system has $\backslash${} (``skip-line''-see \App{C}), you can write
...
\person{Moore}\index{M!Moore, Charles} prefers to define LOAD to
...
ASSEMBLER WORDS
\end{Code}
On the other hand, \person{Moore}\index{M!Moore, Charles} points out that inappropriate names can
...
%!!<SMALLPRINT>
\begin{interview}
The choice of I'M is another invention of \person{Moore}, who says:
