...
\begin{description}
\item[\emph{\forth{\bs}}]~
\item[\emph{\forth{\bs S}}] also called \forth{EXIT}\index{E!EXIT}
\end{description}
...
\forth{EXIT},\index{E!EXIT} which is the run-time routine for
semicolon.  In these systems the use of \forth{EXIT} is acceptable.
