...
DOER JUAN & \\
\hline
\vline\ JUAN & \vline\ dcp\footnote{dirección del campo de parámetros; ``pfa'' en el original, por ``parameter field address''} de NADA \vline \\
\hline
\ header &\  campo de parámetros
\end{tabular}
\bigskip
}
...
\begin{Code}
: BORDON   CHIN-PON CHIN-PON %%*** here there was a ``;''!?
