...
%!! begin ordered list
1. If you're building an Adventure-type game, you'd want to write a language
...
Note: This use of \bf{ASCII} requires that \bf{ASCII} be
...
\bf{C@} requires the \emph{address} of the slot that contains the symbol we
