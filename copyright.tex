...
\includegraphics[scale=\figscale]{img-cc}
...
\begin{description}
\vspace{\baselineskip}
\item[\vbox to\ht\strutbox{\vss\hbox to 0pt{\hss\includegraphics[scale=\figscale]{img-by} }\vss}Attribution.]
You must give the original author credit.
\vspace{\baselineskip}
\vspace{\baselineskip}
\item[\vbox to\ht\strutbox{\vss\hbox to 0pt{\hss\includegraphics[scale=\figscale]{img-nc} }\vss}Noncommercial.]
You may not use this work for commercial purposes.
\vspace{\baselineskip}

\item[\vbox to\ht\strutbox{\vss\hbox to 0pt{\hss\includegraphics[scale=\figscale]{img-sa} }\vss}Share Alike.]
